...
print("\nHasil Transfer:")
for trx in BRIExtractor().extract(data_transfer):
    print(trx)

print("\nHasil Top-Up:")
for trx in BRIExtractor().extract(data_topup):
    print(trx)
...
extractor = OCBCExtractor()

# Extract transactions
transactions_top_up = extractor.extract(data_top_up)
transactions_transfer = extractor.extract(data_transfer)

# Print the extracted transactions
print("Top-Up Transaction Details:")
for trx in transactions_top_up:
    print(trx)

print("\nTransfer Transaction Details:")
for trx in transactions_transfer:
    print(trx)
...
if extractor.match("OVO QR Payment Receipt", "noreply@ovo.co.id"):
    transactions = extractor.extract(data)
